    ...
    return this.each(function() {
        ...
        function updateWidget(){
            ...
            obj.append("<div class='widget now-playing-bar'>"+
                "<div class='current'>"+currentShowName+"</div>"+
                "</div>");
        }
    ...
    $.fn.hyrrdyrr = function(options) {
       ...
       return this.each(function() {
           ...
           function updateWidget(){
               ...
               obj.empty();
			   if ((currentShowName.indexOf("Aktywna Playlista") < 0 )&&(currentShowName.indexOf("Soundtrack") < 0 )) {
               obj.append("<div id='status-current-show'>"+currentShowName+"</div>");
			   }
               if (currentShowName.indexOf("Aktywna Playlista") >= 0 ) {
			   obj.append("<div class='widget now-playing-bar'>" +
                   "<div class='current track-metadata'>"+sd.currentTrack.getTitle()+"</div>" +                   
                   "</div>");
				   }
				else if (currentShowName.indexOf("Soundtrack") >= 0 ) {
			   obj.append("<div class='widget now-playing-bar'>" +
                   "<div class='current track-metadata'>"+sd.currentTrack.getTitle()+"</div>" +                   
                   "</div>");
				   }
